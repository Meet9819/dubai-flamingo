						...
						<main class="col-lg-7 col-xl-8">
							<article class="vertical-item single-post bordered post type-post status-publish format-standard has-post-thumbnail">
								...
								<div class="item-media post-thumbnail">
									<img src="images/services/hydrawlicoils.jpg" alt="">
								</div>
...
<h1>Hydraulic Oils</h1>
										...
										<p>
											The purpose of the insulating oil is to protect the transformer inner core and windings which are completely submerged down in the insulating oil. Also, it is the responsibility of the enclosed Hydraulic Oils to avoid the reaction of oxygen with the paper insulation which is made of cellulose material and thereby extending the life span of the transformer. The transformer insulating oil will act as a blockade between the oxygen available in the atmosphere and the solid insulation (cellulose paper) to prevent their immediate contact and thereby keep down the oxidation reaction. The amount of Insulating mineral oil placed inside the transformer is commonly evaluated by a MOG (Magnetic Oil level Gauge).
										</p>
						...
						<aside class="col-lg-5 col-xl-4">
							...
							<div class="widget widget_search">
								...
								<form role="search" method="get" class="search-form" action="http://html.modernwebtemplates.com/">
							...
							<div class="widget widget_categories">
								...
								<h3 class="widget-title">Oils</h3>

								<ul>
									 
									
									<li class="cat-item">
										<a href="#">Hydraulic Oils</a>
										 
									</li>
									<li class="cat-item">
										<a href="#">Diesel Engine Oil</a>
										 
									</li>
									<li class="cat-item">
										<a href="#">Hydraulic Oilss</a>
...
<!-- Mirrored from html.modernwebtemplates.com/nafta/blog-single-right.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 10 Mar 2021 17:09:11 GMT -->
</html>